...
from plugins.napcat_plugin.ada.logger import logger
from rich.traceback import install

from plugins.napcat_plugin.ada.config.config_base import ConfigBase
from plugins.napcat_plugin.ada.config.official_configs import (
    ChatConfig,
    DebugConfig,
    MaiBotServerConfig,
    NapcatServerConfig,
...
TEMPLATE_DIR = "plugins/napcat_plugin/template"


def update_config():
    # 定义文件路径
    template_path = f"{TEMPLATE_DIR}/template_config.toml"
    old_config_path = "plugins/napcat_plugin/config.toml"
    new_config_path = "plugins/napcat_plugin/config.toml"
...
global_config = load_config(config_path="plugins/napcat_plugin/config.toml")
